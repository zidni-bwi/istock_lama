                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li {!! classActiveSegment(1, 'blog') !!}>
                            <a href="#" data-toggle="collapse" data-target="#articlemenu"><span class="fa fa-fw fa-pencil"></span> {{"Barang"}} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="articlemenu" class="collapse">
                                <li><a href="{!! url('blog') !!}">{{"Daftar Barang"}}</a></li>
                                <li><a href="{!! url('blog/create') !!}">{{"Tambah Barang"}}</a></li>
                            </ul>
                        </li>
